...
import BerkeleyHoodieDesktop from './designs/BerkeleyHoodieDesktop';

const BerkeleyHoodiePage = props => {
          ...
          <div className="design-nav">
              ...
              <button className="button-style">
                <Link to='/design/berkeleyhoodie'>
                  <div className="nav-font"><b>BERKELEY HOODIE</b></div>
                </Link>
              </button>
            
          </div>
          <div className="design-display">
            <BerkeleyHoodieDesktop />
          </div>
...
export default BerkeleyHoodiePage;
