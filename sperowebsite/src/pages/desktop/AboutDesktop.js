...
const AboutPageDesktop = (props) => {
    return (
        ...
        >
            <Navbar />
            <VStack textAlign="center" px={{ base: '30px', lg: '100px' }} color="#5c6a6f" pt="25px"  >
                <Fade bottom>
                ...
                <HStack textAlign="left" color="#5c6a6f" pb="175px" spacing="150px">
                    <VStack textAlign="left" color="#5c6a6f" align="left"
                ...
                <HStack textAlign="left" color="#5c6a6f" pb="150px" spacing="150px">
                    <Fade bottom>
                        <Image
