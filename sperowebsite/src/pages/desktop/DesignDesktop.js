...
const DesignsDesktop = props => {
  const designList = ['walk', 'mountain', 'bear', 'abide', 'hope', 'girl', 'macron', 'bless', 'bay area', 'berkeley']
        ...
        <div className="design-card-container">
          <div className="design-nav">
              ...
              <div className="fall-stickers-nav">
                ...
                <button className="button-style" onClick={()=>switchDesign(0)}>
                  <div className="sub-font">WALK ON WATER</div>
                </button>
                <button className="button-style" onClick={()=>switchDesign(1)}>
                  <div className="sub-font">MOUNTAIN MOVER</div>
                </button>
                <button className="button-style" onClick={()=>switchDesign(2)}>
                  <div className="sub-font">SPERO BEAR</div>
                </button>
              </div>

              <button className="button-style" onClick={()=>switchDesign(3)}>
